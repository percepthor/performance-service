...
static void percepthor_env_get_runtime (void) {
...
static unsigned int percepthor_env_get_port (void) {
...
static void percepthor_env_get_cerver_receive_buffer_size (void) {
...
static void percepthor_env_get_cerver_th_threads (void) {
...
static void percepthor_env_get_cerver_connection_queue (void) {
...
static unsigned int percepthor_init_env (void) {

	unsigned int errors = 0;

	percepthor_env_get_runtime ();

	errors |= percepthor_env_get_port ();

	percepthor_env_get_cerver_receive_buffer_size ();

	percepthor_env_get_cerver_th_threads ();

	percepthor_env_get_cerver_connection_queue ();
...
unsigned int percepthor_init (void) {

	unsigned int errors = 0;

	if (!percepthor_init_env ()) {
		errors |= percepthor_service_init ();
	}
...
unsigned int percepthor_end (void) {

	percepthor_service_end ();
